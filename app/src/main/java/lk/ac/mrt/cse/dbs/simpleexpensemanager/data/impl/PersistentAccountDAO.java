...
public class PersistentAccountDAO implements AccountDAO {
    private final SQLiteDB myDataBase;
    ...
    public List<String> getAccountNumbersList() {
        Cursor res = this.myDataBase.getData(ACCOUNT_TB,new String[] {"accountno"}, new String[][] {});
    ...
    public List<Account> getAccountsList() {
        Cursor res = this.myDataBase.getData(ACCOUNT_TB,new String[] {"*"}, new String[][] {});
    ...
    public Account getAccount(String accountNo) throws InvalidAccountException {
        ...
        Cursor res = this.myDataBase.getData(ACCOUNT_TB,new String[] {"*"}, new String[][] {condition});
        if(res.getCount() == 0){
    ...
    public void addAccount(Account account) {
        ...
        this.myDataBase.insertData(ACCOUNT_TB, accContent);

    }

    @Override
    public void removeAccount(String accountNo) throws InvalidAccountException {
        int result = this.myDataBase.deleteData("account","accountno",accountNo);
        if(result == 0){
    ...
    public void updateBalance(String accountNo, ExpenseType expenseType, double amount) throws InvalidAccountException {
        ...
        boolean result = this.myDataBase.updateData("account",accContent,condition);
        if(!result){
            throw new InvalidAccountException("Account number is invalid");
        }
    }
